...
public interface JournalBlockAPI {
	...
	ResponseEntity<JournalBlockDTO> updatePosition(
			@PathVariable("id") Integer id,
	...
	ResponseEntity<List<JournalBlockDTO>> getAllJournalsByPageId(
